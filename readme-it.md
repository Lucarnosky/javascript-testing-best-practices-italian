...
:white_check_mark: **Do:** Structure your tests with 3 well-separated Paragrafos Arrange, Act & Assert (AAA). Following this structure guarantees that the reader spends no brain-CPU on understanding the test plan:
